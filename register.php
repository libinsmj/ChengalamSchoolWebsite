<?php
	...
	if ( isset($_POST['btn-signup']) ) {
		...
		if( !$error ) {
			...
			$query = "update users set userName='".$name."',userEmail='".$email."',userPass='".$password."' where userId=1";
		
			$res = mysql_query($query);
				
			if ($res) {
				$errTyp = "success";
				$errMSG = "Successfully changed password, you may login now";
				unset($name);
				unset($email);
				unset($pass);
			} else {
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
    	...
    	<div class="col-md-12">
        	...
        	<div class="form-group">
            	<h4 class="" style="color:#d8aa46;">Change Password</h4>
            </div>
            ...
            <div class="form-group">
            	...
            	<input type="text" name="name" class="form-control" placeholder="Enter New Name" maxlength="50" value="<?php echo $name ?>" />
                </div>
            ...
            <div class="form-group">
            	...
            	<input type="email" name="email" class="form-control" placeholder="Enter Your New Email" maxlength="40" value="<?php echo $email ?>" />
                </div>
